...
VITORIA = 'VITORIA' #atributo maiúsculo por se tratar de uma constante
DERROTA = 'DERROTA' #atributo maiúsculo por se tratar de uma constante
EM_ANDAMENTO = 'EM_ANDAMENTO' #atributo maiúsculo por se tratar de uma constante
    ...
    def lancar(self, angulo, tempo):
        ...
        for passaro in self._passaros:
            if not passaro.foi_lancado():
                ...
                break # utilizado para quebrar o "FOR" acima, dar descontinuidade.
